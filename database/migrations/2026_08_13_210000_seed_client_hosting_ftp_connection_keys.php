...
return new class extends Migration
{
    ...
    {
        return [
            'hosting.ftp.connection' => 'Connection Details',
            'hosting.ftp.host' => 'Host',
            'hosting.ftp.port' => 'Port',
            'hosting.ftp.protocol' => 'Protocol',
            'hosting.ftp.protocol_hint' => 'Connect with FTP or FTPS on port 21 — not SFTP (SFTP uses port 22 and a different login).',
        ];
    }
