...
/*
 * Saying "2 GB" while quietly starting four containers is not the truth: the
 * floor applies to the main container, and the database, cache or ML worker
 * beside it draw on the same account allowance.
 */
return new class extends Migration
{
    ...
    {
        return [
            'hosting.containers.services' => '{1} 1 container|[2,*] :count containers',
            'hosting.containers.services_hint' => 'This app runs more than one container - a database, a cache or a worker beside it. They all share your plan\'s memory and CPU.',
        ];
    }
